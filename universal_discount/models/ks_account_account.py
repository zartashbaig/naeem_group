...
class Company(models.Model):
    ...
    ks_enable_discount = fields.Boolean(string="Activate Overall Discount")
...
class KSResConfigSettings(models.TransientModel):
    ...
    ks_enable_discount = fields.Boolean(string="Activate Overall Discount", related='company_id.ks_enable_discount', readonly=False)
